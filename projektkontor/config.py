...
class Config:
    ...
    privacy_controller_name: str = "Betreiber dieser ProjektKontor-Installation"
    privacy_controller_address: str = "Kontaktdaten werden vor dem Produktivbetrieb ergänzt."
    privacy_controller_email: str = "Kontaktdaten werden vor dem Produktivbetrieb ergänzt."
    privacy_dpo_contact: str = "Sofern bestellt: über den Verantwortlichen erreichbar."
    privacy_legal_basis: str = "Die konkrete schulrechtliche Rechtsgrundlage wird vor dem Produktivbetrieb durch die verantwortliche Schule festgelegt."
...
def load_config() -> Config:
    ...
    config = Config(
        ...
        privacy_controller_name=os.getenv("PK_PRIVACY_CONTROLLER_NAME", "Betreiber dieser ProjektKontor-Installation").strip(),
        privacy_controller_address=os.getenv("PK_PRIVACY_CONTROLLER_ADDRESS", "Kontaktdaten werden vor dem Produktivbetrieb ergänzt.").strip(),
        privacy_controller_email=os.getenv("PK_PRIVACY_CONTROLLER_EMAIL", "Kontaktdaten werden vor dem Produktivbetrieb ergänzt.").strip(),
        privacy_dpo_contact=os.getenv("PK_PRIVACY_DPO_CONTACT", "Sofern bestellt: über den Verantwortlichen erreichbar.").strip(),
        privacy_legal_basis=os.getenv("PK_PRIVACY_LEGAL_BASIS", "Die konkrete schulrechtliche Rechtsgrundlage wird vor dem Produktivbetrieb durch die verantwortliche Schule festgelegt.").strip(),
